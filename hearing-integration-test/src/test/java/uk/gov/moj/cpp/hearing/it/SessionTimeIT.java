...
public class SessionTimeIT extends AbstractIT {
    ...
    public void shouldSaveSessionTimeForPartialUpdate() {
        ...
        final JsonObjectBuilder recordSessionTime1 = JsonObjects.createObjectBuilder();
        ...
        final JsonObjectBuilder courtSession = JsonObjects.createObjectBuilder();
        final JsonArrayBuilder judiciaryList = JsonObjects.createArrayBuilder();
        ...
        //Second Request
        final JsonObjectBuilder recordSessionTime2 = JsonObjects.createObjectBuilder();
        ...
        final JsonObjectBuilder amCourtSession2 = JsonObjects.createObjectBuilder();
        final JsonArrayBuilder judiciaryList2 = JsonObjects.createArrayBuilder();
        ...
        final JsonObjectBuilder pmCourtSession2 = JsonObjects.createObjectBuilder();
        final JsonArrayBuilder judiciaryList3 = JsonObjects.createArrayBuilder();
    ...
    private JsonObject recordSessionTime(final UUID courtHouseId, final UUID courtRoomId,
        ...
        final JsonObjectBuilder recordSessionTime = JsonObjects.createObjectBuilder();
    ...
    private JsonObject judiciary(final UUID judId, final String jud1Name, final boolean chair) {
        final JsonObjectBuilder judiciary = JsonObjects.createObjectBuilder();
