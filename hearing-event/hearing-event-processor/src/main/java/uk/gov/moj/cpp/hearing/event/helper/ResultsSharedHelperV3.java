...
public class ResultsSharedHelperV3 {
     ...
     * @return void
     */
    public void setIsDisposedFlagOnOffence(final ResultsSharedV3 resultsShared) {
    ...
    public void cancelFutureHearingDays(final JsonEnvelope context, final Sender sender, final ResultsSharedV3 resultsShared, final ObjectToJsonObjectConverter objectToJsonObjectConverter) {
